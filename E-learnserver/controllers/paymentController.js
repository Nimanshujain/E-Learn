...
export const cancelSubscription = catchAsyncError(async(req,res,next) => {
    ...
    res.status(200).json({
        success:true,
        message:
        refund?"Subscription cancelled, you will receive full payment with in 7 days":"Subscription cancelled, now refund initiated as subscription was canceled after 7 days",
